...
<!-- pageheader
    ...
    <div class="col-full s-content__main">
        <h2 style="text-align: center;">CHEST GUARD</h2>
        <div style="width: 100%; text-align: center;">
            <img src="<?= base_url() ?>/images/gambar/c1.png" alt="">
        </div> 
        <h5>Pelindung Dada (Chest Guard)</h5>
        <p>Pelindung dada atau chest guard digunakan sebagai pelindung dada dari tali. Agar ketika anak panah dilepasakan, tali busur tidak mengenai dada/kaos dari sang pemanah.Tali yang selalu mengenai kaos dari pemanah bisa menyebabkan lesatan anak panah tidak bisa berjalan dengan sempurna.</p>
        <div style="width: 100%; text-align: center;">
            <img src="<?= base_url() ?>/images/gambar/c2.png" alt="">
        </div> 
