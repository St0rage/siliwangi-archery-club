...
<!-- pageheader
    ...
    <div class="col-full s-content__main">
        <h2 style="text-align: center;">CLICKER</h2>
        <div style="width: 100%; text-align: center;">
            <img src="<?= base_url() ?>/images/gambar/clicker/c21.png" alt="">
        </div> 
        <p>Klik anak panah biasanya dipakai oleh pemanah yang sudah menguasai tehnik-tehnik dasar panahan . klicker berfungi sebagai penanda saat anak panah ditari maksimal. Selain itu clicker adalah alat yang berfungsi untuk memeriksa panjang tarikan agar konsisten. Saat menarik string, setelah ujung arrow melewati tepi clicker, clicker akan berbunyi. Arrow dapat cepat direlease kalau terdengar bunyi click</p> 
