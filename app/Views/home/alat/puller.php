...
<!-- pageheader
    ...
    <div class="col-full s-content__main">
        <h2 style="text-align: center;">PULLER</h2>
        <div style="width: 50%; text-align: center;">
            <img src="<?= base_url() ?>/images/gambar/puler/p1.png" alt="" style="margin: auto;">
        </div> 
        <h5>Penarik Anak Panah (Puller)</h5>
        <p>Penarik anak panah atau Puller, adalah alat yang di gunakan untuk menarik arrow yang menancap pada target. Karena arrow yang menancap pada target berbeda kedalamannya. arrow yang menancap sangat dalam akan sulit di tarik, apabila tidak menggunakan bantuan puller. Dengan menggunakan puller akan mempermudah pemanah dalam menarik arrow .</p>
