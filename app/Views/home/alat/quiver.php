...
<!-- pageheader
    ...
    <div class="col-full s-content__main">
        <h2 style="text-align: center;">QUIVER</h2>
        <div style="width: 100%; text-align: center;">
            <img src="<?= base_url() ?>/images/gambar/quiver/quiver1.png" alt="">
        </div> 
        <p>Kantong Panah (Quiver) : Kantong panah berfungsi untuk menempatkan anak panah. Anak panah apabila ditempatkan sembarangan tempat akan mudah rusak terutama bulunya. Bahan yang digunakan ada yang terbuat dari kulit, tetapi ada juga yang terbuat dari campuan plastik. Panjang kantong anak panah yang bagus disesuaikan dengan panjang anak panah yang dimiliki masing-masing anak pemanah.</p>
