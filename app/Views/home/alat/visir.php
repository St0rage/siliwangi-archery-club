...
<!-- pageheader
    ...
    <div class="col-full s-content__main">
        <h2 style="text-align: center;">VISIR</h2>
        <div style="width: 100%; text-align: center;">
            <img src="<?= base_url() ?>/images/gambar/visir/vsr1.png" alt="">
        </div> 
        <p>Penggunaan alat pembidik ini sangat penting karena dalam pertandingan panahan jarak yang digunakan setiap ronde berbeda-beda setiap jaraknya, maka dari itu setiap pemanah akan selalu mengubah alat pembidik dalam setiap jarak apabila pemanah dalam bertanding lupa dalam mengubah alat tersebut ketika terjadi perpindahan jarak, maka akibatnya fatal dalam perolehan point.</p>
